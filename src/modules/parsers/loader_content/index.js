...
function change_group_tag(old_tag, new_tag, old_buffer) {
    if (old_tag == "ExportAccrualsPaymentsPackage") {
        ...
        buffer_nsi_standard.append([buffer_nsi_row])
    }
...
function create_table(table_name) {
    ...
    create_query = `CREATE TABLE ${table_name + "_error"} (`
    create_query += "UNKNOWN_TAG_JSON character varying(300)"
    create_query += ");"
    cursor.execute(create_query)
    connection.commit()

    create_query = `CREATE TABLE ${table_name + "$HOUSE"} (`
    ...
    create_query = `CREATE TABLE ${table_name + "$HOUSE_error"} (`
    create_query += "UNKNOWN_TAG_JSON character varying(300)"
    create_query += ");"
    cursor.execute(create_query)
    connection.commit()

    create_query = `CREATE TABLE ${table_name + "$NSI_HOUSE"} (`
    ...
    create_query = `CREATE TABLE ${table_name + "$communal_rate_consumption"} (`
    create_query += "jkh_house_code character varying(300),"
    ...
    create_query = `CREATE TABLE ${table_name + "$communal_rate_consumption_error"} (`
    create_query += "UNKNOWN_TAG_JSON character varying(300)"
    create_query += ");"
    cursor.execute(create_query)
    connection.commit()

    create_query = `CREATE TABLE ${table_name + "$communal_rate_criterion"} (`
    ...
    create_query = `CREATE TABLE ${table_name + "$nsi_communal"} (`
    create_query += "jkh_house_code character varying(300),"
    create_query += "link_name character varying(300),"
    create_query += "code character varying(300),"
    create_query += "guid character varying(300),"
    ...
    create_query = `CREATE TABLE ${table_name + "$standard"} (`
    create_query += "jkh_house_code character varying(300),"
    ...
    create_query = `CREATE TABLE ${table_name + "$standard_error"} (`
    create_query += "UNKNOWN_TAG_JSON character varying(300)"
    create_query += ");"
    cursor.execute(create_query)
    connection.commit()

    create_query = `CREATE TABLE ${table_name + "$nsi_standard"} (`
    create_query += "jkh_house_code character varying(300),"
    create_query += "link_name character varying(300),"
    create_query += "code character varying(300),"
    create_query += "name character varying(300),"
    ...
    create_query = `CREATE TABLE ${table_name + "$unified_account"} (`
    create_query += "jkh_house_code character varying(300),"
    ...
    create_query = `CREATE TABLE ${table_name} +"$unified_account_error" (`
    create_query += "UNKNOWN_TAG_JSON character varying(300)"
    create_query += ");"
    cursor.execute(create_query)
    connection.commit()

    create_query = `CREATE TABLE ${table_name + "$nsi_unified_account"} (`
    create_query += "jkh_house_code character varying(300),"
    create_query += "link_name character varying(300),"
    create_query += "code character varying(300),"
    create_query += "guid character varying(300),"
    ...
    create_query = `CREATE TABLE ${table_name + "$payment_unified_account"} (`
    create_query += "jkh_house_code character varying(300),"
    ...
    create_query = `CREATE TABLE ${table_name + "$payment_service"} (`
    create_query += "jkh_house_code character varying(300),"
    create_query += "payment-document-guid character varying(300),"
    create_query += "guid character varying(300),"
    ...
    create_query = `CREATE TABLE ${table_name + "$provider_service"} (`
    create_query += "jkh_house_code character varying(300),"
    create_query += "payment-document-guid character varying(300),"
...
function bulk_insert(table_name, isBox, buffer_save, chunk) {
    connection = utils.connect()
    if (!connection) {
        raise("Can`t establish connection to database")
    }
    ...
    for (elem in root.iter()) {
        ...
        if (current_tag == "ExportAccrualsPaymentsPackage") {
            ...
            if (group_tag != "communal-rate-consumption") {
                ...
                if (buffer_row.get("root_rate_guid", None)) {
        ...
        if (group_tag == "ExportAccrualsPaymentsPackage") {
            ...
            if (current_tag in buffer_standard[1]) {
                if (current_tag in buffer_nsi_standard[0]) {
                    buffer_nsi_row["link_name"] = nsi_tag
                    buffer_nsi_row[current_tag] = elem.text
                } else {
                    buffer_row[current_tag] = elem.text
...
if (buffer_standard_commun) {
    bulk_insert(table_name + "$standard", True, buffer_standard, 1000)
    buffer_standard.clear()
}
if (buffer_nsi_standard) {
    bulk_insert(table_name + "$nsi_standard", False, buffer_nsi_standard, 1000)
    buffer_nsi_standard.clear()
}
